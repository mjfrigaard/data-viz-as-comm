...
### Focus on US Cities During Spring/Summer
...
Filter `TidyApple` to the largest US cities (by [population](https://en.wikipedia.org/wiki/List_of_United_States_cities_by_population)).
